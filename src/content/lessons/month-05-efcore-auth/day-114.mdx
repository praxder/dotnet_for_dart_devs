...
public class BlogApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            // Replace production Dapper infrastructure with the container database.
    ...
    public async Task InitializeAsync()
    {
        ...
        // Run the same reviewed SQL migrations used by deployment.
    ...
    : IClassFixture<BlogApiFactory>, IAsyncLifetime
{
    ...
    protected IPostRepository Posts = null!;
    protected IAuthorRepository Authors = null!;

    public async Task InitializeAsync()
    {
        _scope = factory.Services.CreateAsyncScope();
        DataSource = _scope.ServiceProvider.GetRequiredService<NpgsqlDataSource>();
        Posts = _scope.ServiceProvider.GetRequiredService<IPostRepository>();
        Authors = _scope.ServiceProvider.GetRequiredService<IAuthorRepository>();
    ...
    : IntegrationTestBase(factory)
{
    ...
    {
        var user = await CreateUserAsync("author@test.com", "Author");
        _author = await Authors.CreateAsync("Test Author", "author@test.com", user.Id);
    }
    ...
    public async Task PublishPost_AsOwner_Returns200()
    {
        ...
        // Verify in database
        var dbPost = await Posts.GetByIdAsync(post.Id);
    ...
    public async Task GetPost_Published_IncrementsViewCount()
    {
        ...
        // Assert
        var reloaded = await Posts.GetByIdAsync(post.Id);
        Assert.Equal(3, reloaded!.ViewCount);
    }
