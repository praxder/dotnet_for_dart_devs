...
2. **Create and explore**: Run `dotnet new console -n DartDevIntro`. Open `DartDevIntro.csproj` and identify each XML property. What does `TargetFramework` control? What happens if you change `net10.0` to `net8.0`?
