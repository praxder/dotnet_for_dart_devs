...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    weeks: [19, 21],
    days: [91, 105],
    description: 'The standard .NET ORM: DbContext, migrations, relationships, and querying with LINQ. Covers repository pattern, CQRS with MediatR, and integration testing against a real database.',
    color: '#10b981',
    icon: '🗄️',
  },
  {
