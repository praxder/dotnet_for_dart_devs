...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    weeks: [19, 21],
    days: [91, 105],
    description: 'Micro-ORM with full SQL control: parameterized queries, multi-mapping, transactions, CQRS with MediatR, and integration testing. Like sqflite, but for the server.',
    color: '#10b981',
    icon: '🗄️',
  },
  {
