...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    weeks: [8, 10],
    days: [36, 50],
    description: 'C# collections, generic constraints, and LINQ — the powerful query system we use constantly in production. Master Where, Select, GroupBy, and more; understand deferred execution and write expressive, readable data transformations.',
    color: '#ec4899',
    icon: '📦',
  },
  {
  ...
  },
  {
    id: 8,
    slug: 'dapper',
    name: 'Dapper & SQL Data Access',
    shortName: 'Dapper',
    phase: 'dotnet',
    weeks: [19, 21],
    days: [91, 105],
    description: 'SQL-first data access with Dapper: safe parameters, mapping, transactions, repositories, migrations, performance, and integration tests against a real database.',
    color: '#10b981',
    icon: '🗄️',
  },
  {
  ...
  },
  {
    ...
    weeks: [24, 26],
    days: [116, 130],
    description: 'Unit and integration testing with xUnit/Moq, and deploying with Docker. Final capstone: a full API for a Flutter app.',
    color: '#84cc16',
    icon: '🚀',
  },
];
